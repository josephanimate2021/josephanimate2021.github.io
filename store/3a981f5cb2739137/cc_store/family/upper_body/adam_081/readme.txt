Comedy World Custom Clothing: Adam Long-Sleeved Polo Shirt
...
5. Copy the whole component, create a new line, and replace the "xx" with the number you set the Long-Sleeved Polo Shirt folder to.

6. You're done! Go to the Character Creator on Wrapper online and the Long-Sleeved Polo Shirt should be there!
